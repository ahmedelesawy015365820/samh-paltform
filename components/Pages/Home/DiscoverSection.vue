<template>
  <div class="discover_section">
    <header class="header text-center">
      <h2 class="h_2 mb-2">{{ $t("pages.home.discover.title") }}</h2>
    ...
    <main class="main my-16">
      ...
      >
        <swiper-slide v-for="property in properties" :key="property.id">
          <SingleProperty :dir="useHelpers().dir()" :property="property" />
        </swiper-slide>
